...
HD_PWD='D:/Desktop/Study_now/SRW/GoertzelAlgorithm/vivado/project/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourierTransform.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourierTransform.tcl
