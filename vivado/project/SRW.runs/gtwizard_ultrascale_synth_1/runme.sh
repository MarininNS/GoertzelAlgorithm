...
HD_PWD='D:/Desktop/Study_now/SRW/GoertzelAlgorithm/vivado/project/SRW.runs/gtwizard_ultrascale_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtwizard_ultrascale.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gtwizard_ultrascale.tcl
