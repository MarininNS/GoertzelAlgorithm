...
#
# Generated by export_simulation on Thu May 04 22:46:52 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './gtwizard_ultrascale_vio_0.sh' script.

./gtwizard_ultrascale_vio_0.sh -reset_run
...
./gtwizard_ultrascale_vio_0.sh -noclean_files

For more information on the script, please type './gtwizard_ultrascale_vio_0.sh -help'.
